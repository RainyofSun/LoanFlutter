...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<AppInitCircuit>[] is M) {
      return data.map<AppInitCircuit>((Map<String, dynamic> e) =>
          AppInitCircuit.fromJson(e)).toList() as M;
    }
    if (<AppInitPractical>[] is M) {
      return data.map<AppInitPractical>((Map<String, dynamic> e) =>
          AppInitPractical.fromJson(e)).toList() as M;
    }
    if (<UserEntity>[] is M) {
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (AppInitCircuit).toString(): AppInitCircuit.fromJson,
    (AppInitPractical).toString(): AppInitPractical.fromJson,
